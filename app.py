...
if arquivo: 
    ...
    with aba1:
        ...
        #fig1 = figura (o papel todo)
        #ax1 = Eixo (ou quadro) desenha os gráficos
    ...
    with aba2:
        ...
        with col5:
            ...
            salaria_area.plot(kind="barh", color="red", ax=ax2)
    ...
    st.warning("Por favor, carregue um arquivo Excel para inicia a análise")
